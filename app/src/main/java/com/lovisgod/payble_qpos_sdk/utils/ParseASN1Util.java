...
public class ParseASN1Util {
    ...
    public static void parseASN1(String s){
        byte[] data = QPOSConversionUtil.HexStringToByteArray(s);
...
//                        System.out.println("prop33->"+re2);
    ...
    public static String getSHA256Value(String str){
        ...
        try {
            ...
            encodestr = QPOSConversionUtil.byteArray2Hex(messageDigest.digest());
...
//        System.out.println("tr31 = "+tr31Data.substring(1));
    ...
    public static String generateNonce() {
        try {
            ...
            String nonce = QPOSConversionUtil.byteArray2Hex(bytes_key);
            return nonce;
        } catch (Exception e) {
            e.printStackTrace();
        }
